...
MCP server for [Rhodium11](https://rhodium11.com). Exposes 21 tools for managing projects, schedules, orders, wallet, and feedback through any MCP-compatible AI agent.
...
| `rh11_keywords_projection` | Research candidate keywords before creating projects (max 100/call) |
